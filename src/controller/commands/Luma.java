...
/**
 * This class represents the luma image manipulation function.
 */
public class Luma implements CommandController {
    ...
    if (listOfCommands.length == argumentCountSplit) {
      if (this.listOfCommands[splitKey].equalsIgnoreCase("split")) {
        if (this.listOfCommands[percentValue] != null) {
          model.lumaCommand(this.listOfCommands[parentImageIndex],
