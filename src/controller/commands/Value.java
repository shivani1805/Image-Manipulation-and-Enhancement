...
/**
 * This class represents the value image manipulation function.
 */
public class Value implements CommandController {
  ...
  public void commandExecution(CommandModel model) throws IllegalArgumentException, IOException {
    ...
    model.valueCommand(this.listOfCommands[parentImageIndex],
