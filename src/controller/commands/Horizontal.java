...
/**
 * This class represents the horizontal flip image manipulation function.
 */
public class Horizontal implements CommandController {
  ...
  public Horizontal(String arguments) {
  ...
  public void commandExecution(CommandModel model) throws IllegalArgumentException, IOException {
    ...
    model.horizontalCommand(this.listOfCommands[parentImageIndex],
