...
/**
 * This class represents the red component extraction image manipulation function.
 */
public class RedComponent implements CommandController {
  ...
  public RedComponent(String arguments) {
  ...
  public void commandExecution(CommandModel model) throws IllegalArgumentException, IOException {
    ...
    model.redComponentCommand(this.listOfCommands[parentImageIndex],
