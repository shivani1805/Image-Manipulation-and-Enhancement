...
/**
 * This class represents the sharpen image manipulation function.
 */
public class Sharpen implements CommandController {
  ...
  public Sharpen(String arguments) {
    ...
    if (listOfCommands.length == argumentCountSplit) {
      if (this.listOfCommands[splitKey].equalsIgnoreCase("split")) {
        if (this.listOfCommands[percentValue] != null) {
          model.sharpenCommand(this.listOfCommands[parentImageIndex],
