...
/**
 * This class represents the sepia image manipulation function.
 */
public class Sepia implements CommandController {
    ...
    if (listOfCommands.length == argumentCountSplit) {
      if (this.listOfCommands[splitKey].equalsIgnoreCase("split")) {
        if (this.listOfCommands[percentValue] != null) {
          model.sepiaCommand(this.listOfCommands[parentImageIndex],
